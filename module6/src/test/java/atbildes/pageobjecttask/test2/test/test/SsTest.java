package atbildes.pageobjecttask.test2.test.test;

import atbildes.pageobjecttask.test2.test.enums.Language;
import atbildes.pageobjecttask.test2.test.pageobject.SearchPage;
import atbildes.pageobjecttask.test2.test.pageobject.SearchResultPage;
import atbildes.pageobjecttask.test2.test.pageobject.TopMenuBar;
...
//    }
    ...
    public void testSearch() throws Exception{
        topMenuBar = new TopMenuBar(driver);
        SearchPage searchPage= topMenuBar.changeLanguage(Language.RU)
